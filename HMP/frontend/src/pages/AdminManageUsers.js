...
import '../components/styles/AdminManageUsers.css';
...
const AdminManageUsers = () => {
  ...
  const fetchPatients = async () => {
    try {
      ...
      showErrorToast('Error fetching patients.');
    }
  };
  ...
  const handleAddPatient = async () => {
    try {
      ...
      showErrorToast('Error adding patient.');
    }
  };
  ...
  const handleAddDoctor = async () => {
    try {
      ...
      showErrorToast('Error adding doctor.');
    }
  };
  ...
  const handleUpdatePatient = async () => {
    try {
      ...
      showErrorToast('Error updating patient.');
    }
  };
  ...
  const handleUpdateDoctor = async () => {
    try {
      ...
      showErrorToast('Error updating doctor.');
    }
  };
